...
|  参数名   | 可选  | 含义 |
|  ----  | ----  | ---- |
| idnum  | 必选 | 公交线路完整名称，如：闵行15路。如需要上海市所有公交线路名称，请参考 [末尾附录](#上海市所有公交线路名称（2019-08-25）)。
...
| ${sid}  | 必选 |  公交线路唯一标识符，参考 [查询公交线路编号 API](#查询公交线路编号-API) 接口
...
|  ----  | ----  | ---- |
| sid  | 必选 | 公交线路唯一标识符
| stopid  | 必选 | 途径站点编号信息， [查询公交线路详情](#查询公交线路详情（页面）) 页面可以查询到该编号
